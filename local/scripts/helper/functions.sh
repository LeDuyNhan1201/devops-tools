...
create_files_from_templates() {
  ...
  local templates=(
    "general/kafka/templates/server.template:$MODE/kafka/configs/server.properties"
    "general/kafka/templates/client.template:$MODE/kafka/configs/client.properties"
...
create_data_folders() {
  ...
  create_dir true "$DATA_DIR/pg-data"
